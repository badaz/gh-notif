...
// Favicon: the GitHub mark in accent blue with a bell (octicon `bell-fill`, ~9 px)
// as a badge flush with the top-right corner, embedded as an SVG data-URI (zero external
...
const FAVICON =
  ...
  "<circle class='h' cx='13.1' cy='4' r='4.9'/>" +
